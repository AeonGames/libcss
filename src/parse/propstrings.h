...
enum {
	...
	TABLE_LAYOUT, TEXT_ALIGN, TEXT_ANCHOR, TEXT_DECORATION, TEXT_INDENT, TEXT_TRANSFORM,
	...
	INFINITE, GRID, INLINE_GRID, STICKY, CALC, CONTEXT_FILL, CONTEXT_STROKE,
	MATRIX, START, LIBCSS_END,
