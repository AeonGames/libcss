> [!NOTE]  
> This is a Fork of the [original libCSS](https://www.netsurf-browser.org/projects/libcss/), this fork contains patches to support SVG CSS attributes in addition to the base library needed for [AeonGUI](https://github.com/AeonGames/AeonGUI).
